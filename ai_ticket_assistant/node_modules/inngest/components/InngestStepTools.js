    ...
    const tools = {
        ...
        ai: {
            ...
            infer: createTool(({ id, name }, options) => {
                ...
                const { model, body } = options, rest = __rest(options, ["model", "body"]);
                ...
                return {
                    ...
                    displayName: name !== null && name !== void 0 ? name : id,
                    opts: Object.assign({ type: "step.ai.infer", url: modelCopy.url, headers: modelCopy.headers, auth_key: modelCopy.authKey, format: modelCopy.format, 
                        // eslint-disable-next-line
                        body }, rest),
                };
            }),
